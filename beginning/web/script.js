...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    printOnConsole(e) {
      var t1;
      e.preventDefault();
      t1 = $.$get$link().getAttribute("href");
      if (t1 == null)
        t1 = A._asString(t1);
      A.print("clicked");
      A.print("Clicked on " + t1);
    },
    main() {
      var t2,
        t1 = document.querySelector("#link");
      if (t1 == null)
        t1 = type$.Element._as(t1);
      $.link = t1;
      t1 = J.get$onClick$x(t1);
      t2 = t1.$ti;
      A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(A.link__printOnConsole$closure()), false, t2._precomputed1);
    }
  },
  J = {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "link__printOnConsole$closure", "printOnConsole", 3);
  })();
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.Event, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "link", "$get$link", () => type$.Element._as(""));
  })();
